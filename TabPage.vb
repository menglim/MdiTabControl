...
Public Class TabPage
    ...
    Friend Event CloseAllMenuEventHandler As EventHandler
    Friend Event CloseOthersMenuEventHandler As EventHandler

    Public m_ContextMenuStrip As ContextMenuStrip
    ...
    Sub New(ByVal Form As System.Windows.Forms.Form)
        ...
        Dim closeMeToolStripItem As New ToolStripMenuItem() With {
            .Text = "Close"
            }
        AddHandler closeMeToolStripItem.Click, AddressOf closeMeToolStripItemClicked
        m_ContextMenuStrip.Items.Add(closeMeToolStripItem)

        Dim closeOthersToolStripItem As New ToolStripMenuItem() With {
            .Text = "Close Others"
            }
        AddHandler closeOthersToolStripItem.Click, AddressOf closeOthersToolStripItemClicked
        m_ContextMenuStrip.Items.Add(closeOthersToolStripItem)

        Dim closeAllToolStripItem As New ToolStripMenuItem() With {
            .Text = "Close All"
            }
        AddHandler closeAllToolStripItem.Click, AddressOf CloseAllMenuEventHandler_Click
        m_ContextMenuStrip.Items.Add(closeAllToolStripItem)
    ...
    Private Sub closeOthersToolStripItemClicked(sender As Object, e As EventArgs)
        RaiseEvent CloseOthersMenuEventHandler(sender, e)
    End Sub

    Private Sub CloseAllMenuEventHandler_Click(sender As Object, e As EventArgs)
        RaiseEvent CloseAllMenuEventHandler(sender, e)
    End Sub
    Private Sub closeMeToolStripItemClicked(sender As Object, e As EventArgs)
        If Me.m_Form IsNot Nothing Then
            Me.m_Form.Close()
        End If
    End Sub
    'Private Sub closeAllToolStripItemClicked(sender As Object, e As EventArgs)
    '    'If Me.m_Form IsNot Nothing Then
    '    '    Dim frmMain As Form
    '    '    frmMain = Application.OpenForms.Item("frmMain")
    '    '    If frmMain IsNot Nothing Then
    '    '        Dim tabControl As TabControl
    '    '        tabControl = frmMain.Controls.Cast(Of TabControl)().FirstOrDefault()
    '    '        For index As Integer = 1 To tabControl.TabPages.Count - 1
    '    '            tabControl.TabPages.Item(index).closeMeToolStripItemClicked(sender, e)
    '    '            'tabControl.TabPages.Item(index)
    '    '        Next
