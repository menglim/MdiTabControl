...
#Region " Class TabPageCollection "
    ...
    Public Class TabPageCollection
        ...
        Public Function Add(ByVal Form As Form) As TabPage
            ...
            AddHandler TabPage.CloseAllMenuEventHandler, AddressOf CloseAllTabsEventHandler
            AddHandler TabPage.CloseOthersMenuEventHandler, AddressOf CloseAllOthersEventHandler
        ...
        Sub CloseAllTabsEventHandler(ByVal sender As Object, ByVal e As EventArgs)
            For index As Integer = Me.TabControl.TabPages.Count - 1 To 0 Step -1
                Me.TabControl.TabPages.Item(index).m_Form.Close()
            Next
        End Sub

        Sub CloseAllOthersEventHandler(ByVal sender As Object, ByVal e As EventArgs)
            For index As Integer = Me.TabControl.TabPages.Count - 1 To 0 Step -1
...
#End Region
    ...
    <Browsable(True), Category("Appearance"), DefaultValue(Drawing2D.SmoothingMode.None), Description("Specifies whether smoothing (antialiasing) is applied to lines and curves and the edges of filled areas.")>
...
#Region "Keyboard Handler"
    ...
    Private Sub Owner_KeyDown(ByVal sender As Object,
        ByVal e As System.Windows.Forms.KeyEventArgs)
        If TabPages.Count = 0 Then Exit Sub
        Dim ke As New KeyHandledEventArgs
        Dim Index As Integer
        If KeyTabEnabled And e.KeyCode = Keys.Tab And
        ...
        ElseIf KeyCloseEnabled And e.KeyCode = Keys.F4 And
